...
from gymnasium.wrappers import ResizeObservation, AddRenderObservation
...
def main(config): 
    ...
    env = PendulumWrapper(gym.make(env_id, render_mode="rgb_array"))
    evaluation_env = PendulumWrapper(gym.make(env_id, render_mode="rgb_array"))
